  ...
  return (
    <button
      ...
      style={{
        ...
        borderRadius: "var(--radius-md)",
        border: active
          ? "1.5px solid var(--color-indigo-ink)"
          : "1px solid var(--color-frost)",
        background: active ? "var(--color-periwinkle-wash)" : "var(--color-pure-white)",
        color: active ? "var(--color-indigo-ink)" : "var(--color-slate)",
        fontSize: 12,
  ...
  return (
    <label style={{ display: "flex", flexDirection: "column", gap: 3 }}>
      ...
      <input
        ...
        onFocus={(e) => {
          e.currentTarget.style.borderColor = "var(--color-indigo-ink)";
        }}
        onBlur={(e) => {
